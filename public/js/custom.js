...
$(document).ready(function () {
    ...
    $(document).on("change", "#product-type", function() {
        ...
        if(productType == 'variable'){
            ...
            $('.options_group_pricing').hide();
        } else {
            $('.options_group_pricing').show();
        ...
        $.ajax({
            ...
            success: function(data) {
                if( data['success'] ) {
                    ...
                    attributeHtml   += '<a href="#" class="remove_row delete">Remove</a>';
                    ...
                    attributeHtml   += '</select><button class="button plus select_all_attributes">Select all</button><button class="button minus select_no_attributes">Select none</button></td>';
                    attributeHtml   += '</tr>';
    ...
    $(document).on('click', '.do_variation_action', function(){
        ...
        let variatonHtml   = '<div class="woocommerce_variation wc-metabox open"><h3><a href="#" class="remove_variation delete" rel="312">Remove</a><div class="handlediv" aria-label="Click to toggle"></div><div class="tips sort"></div><div class"variation_fields_section"></div>';
